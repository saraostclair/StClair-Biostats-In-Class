...
Black morph looks more common in industrial and red in rural settings. We expect to REJECT the null that morphs are distributed equally between the two habitats.
...
## Now try on your own
Use the data set called covid_vaccines.
